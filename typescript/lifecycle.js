...
var DemoComponent = function () {
    ...
    var DemoComponent = _classThis = /** @class */ (function () {
        function DemoComponent_1() {
            this.title = __runInitializers(this, _title_initializers, '');
            __runInitializers(this, _title_extraInitializers);
            console.log('constructor');
        }
        DemoComponent_1.prototype.ngOnChanges = function () {
            console.log('ngOnChanges');
        };
        DemoComponent_1.prototype.ngOnInit = function () {
            console.log('ngOnInit');
        };
        DemoComponent_1.prototype.ngOnDestroy = function () {
            console.log('ngOnDestroy');
        };
        return DemoComponent_1;
    }());
